...
public class AgricListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agric_list);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("List of records");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Uploading your data", Snackbar.LENGTH_LONG)
                    ...
                    public void onClick(DialogInterface dialog, int choice) {
                        switch (choice) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                databaseHelper=new DatabaseHelper(AgricListActivity.this);
                                s=String.valueOf(databaseHelper.cur2Json(databaseHelper.reaData()));

                                Log.d("SQL-JSON",s);

                                Toast.makeText(AgricListActivity.this, "Starting to upload data ...", Toast.LENGTH_SHORT).show();

                                HashMap hashMap = new HashMap();
                                hashMap.put("DATA",s);
                                PostResponseAsyncTask postResponseAsyncTask = new PostResponseAsyncTask(AgricListActivity.this, hashMap, new AsyncResponse() {
                                    @Override
                                    public void processFinish(String s) {
                                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AgricListActivity.this);
                                ...
                                postResponseAsyncTask.execute(IP_ADDRESS+"collect/agric");
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AgricListActivity.this);
        ...
        dict.addStringField(R.id.key_id, new StringExtractor<Goapphelper>() {
            @Override
        ...
        dict.addStringField(R.id.parish, new StringExtractor<Goapphelper>() {
            @Override
            public String getStringValue(Goapphelper item, int position) {
                return "Parish: "+item.parish;
            }
        });

        dict.addStringField(R.id.phone_id, new StringExtractor<Goapphelper>() {
            @Override
            public String getStringValue(Goapphelper item, int position) {
                return "Phone id: "+item.phone_id;
            }
        });

        dict.addStringField(R.id.staffName, new StringExtractor<Goapphelper>() {
            @Override
            public String getStringValue(Goapphelper item, int position) {
                return "Staff Name: "+item.staffName;
            }
        });
        ...
        dict.addStringField(R.id.date_recorded, new StringExtractor<Goapphelper>() {
            @Override
            public String getStringValue(Goapphelper item, int position) {
                return "Date recorded: "+item.date_recorded;
            }
        });
        ...
        FunDapter<Goapphelper> fundupter = new FunDapter<>(AgricListActivity.this, nacHelpers, R.layout.records_layout, dict);
                    ...
                    public void onClick(DialogInterface dialog, int choice) {
                        switch (choice) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                DatabaseHelper databaseHelper = new DatabaseHelper(AgricListActivity.this);
                                databaseHelper.deleteSingleRow(data.id);
